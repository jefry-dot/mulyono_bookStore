...
const Login = () => {
  ...
  return (
    <div className='h-[calc(80vh-100px)] flex justify-center items-center'>
        <div className='w-full max-w-xs mx-auto bg-white shadow-md rounded px-6 pt-4 pb-6 mb-4'>
            <h2 className='text-xl font-semibold sm-4'>Please Login</h2>

            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-2'>
                <label className='block-gray-700 text-sm font-bold mb-2' 
            ...
            <div className='mt-4'>
                ...
                bg-secondary hover:bg-lue-700 text-white font-bold py-2 px-4 rounded focus:outline-none'>
